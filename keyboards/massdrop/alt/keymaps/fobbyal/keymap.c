...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi_blocker(
        ...
        FBA_CTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, \
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   KC_PGDN, \
        KC_LCTL, KC_LALT, KC_LGUI,                            FBA_SPC,                             KC_RALT,   MO(1),KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    [1] = LAYOUT_65_ansi_blocker(
        ...
        _______, RGB_TOG, _______, _______, _______, MD_BOOT, NK_TOGG, DBG_TOG, _______, _______, _______, _______,          KC_VOLU, KC_VOLU, \
        _______, _______, _______,                            KC_SPC,                            _______, _______, KC_HOME, KC_VOLD, KC_END   \
    ),
    [2] = LAYOUT_65_ansi_blocker(
        KC_ESC,  KC_F1,   KC_F2,     KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL, KC_MPLY, \
        _______, KC_HOME, _______,  KC_END, _______, _______, _______, KC_PGUP, _______, _______, _______, _______, _______, _______, _______, \
...
/* have to figure out what kind of led i want
led_instruction_t led_instructions[] = {
    ...
    //When layer 1 is active, key LEDs use red    (id0  32 -  16: 0000 0000 0000 0000 0000 0000 0001 1110 ) (F1 - F4) backwards
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x1E, .r = 255, .layer = 2 },
    //When layer 1 is active, key LEDs use red    (id0  32 -  16: 0000 0000 0000 0000 0000 0001 1110 0000 ) (F1 - F4) backwards
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x1E0, .g = 255, .layer = 2 },
    //When layer 1 is active, key LEDs use red    (id0  32 -  16: 0000 0000 0000 0000 0001 1110 0000 0000 ) (F1 - F4) backwards
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x1E00, .b = 255, .layer = 2 },
    //When layer 1 is active, key LEDs use red    (id0  32 -  16: 0000 0000 0000 0001 1110 0000 0000 0000 ) (F1 - F4) backwards
