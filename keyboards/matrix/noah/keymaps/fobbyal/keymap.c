...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_default(
        ...
        KC_CAPS, KC_LALT,   KC_LGUI,                   FBA_SPC,                      KC_RALT,     MO(1),  KC_LEFT,  KC_DOWN, KC_RIGHT),
    [1] = LAYOUT_default(
    ...
    [2] = LAYOUT_default(
        ...
        _______, KC_MPRV,  KC_MPLY, KC_MNXT, _______,  KC_SPC, _______, _______, _______,   _______,  _______,  _______, _______, _______,
        _______, _______,  _______,                   _______,                   _______,   _______,  _______,  _______, _______),
};
