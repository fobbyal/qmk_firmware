...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_69(
        ...
        KC_LCTL, KC_LOPT,  KC_LCMD,           KC_SPC,           MO(_FN1), MO(_FN3),         FBA_SPC,            KC_RCMD,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN2] = LAYOUT_ansi_69(
        ...
        _______,           KC_MPRV,  KC_MPLY, KC_MNXT, _______, _______,  _______, NK_TOGG, _______, _______,  _______,  _______,  _______, _______,
        _______, _______,  _______,           _______,          _______,  _______,          _______,           _______,            _______, _______, _______),
